...
Cleaned version: Removed SQLite fallback and enforced PostgreSQL for stability.
"""
...
from config import add_trusted_mac, get_trusted_macs, normalize_mac
...
def build_database_url() -> str:
    """
    Builds PostgreSQL URL and enforces its availability.
    Removed SQLite fallback to prevent performance degradation.
    """
    ...
    # التحقق من وجود المكتبة المطلوبة
    ...
    # التحقق من أن قاعدة البيانات مفتوحة وبترد
...
def register_routes(app):
    ...
    def add_trusted():
        ...
        # Save both MAC and SSID to JSON dictionary
